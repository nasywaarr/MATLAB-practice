...
The data file has been modified from the original to reduce the file size by removing variables (columns) not required within the course materials.  The full data file can be found at the URL referenced above.
